...
export default function CoursePlayer() {
  ...
  // --- Chapters Data (with MCQ and Fill-in-the-Blank) ---
 ...
 `,
  ...
  const QuizComponent = ({
    ...
    const handleMCQ = (answer: string) => {
      ...
      if (answer === q.correctAnswer) setScore(score + 1);
    };
        ...
        {q.type === "mcq" ? (
          ...
          <form onSubmit={handleFill} className="flex gap-2 items-center">
            <input
              ...
              className="p-2 rounded border dark:bg-gray-100 dark:text-black"
              disabled={showFeedback}
  ...
  return (
    ...
    <div className={`min-h-screen transition-colors duration-300 `}>
      ...
      <div className="flex items-center justify-between max-w-4xl mx-auto pt-8 pb-4 px-4">
        <h1 className="text-3xl font-extrabold tracking-tight">CSS Interactive Course</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 mb-8">
        <div className="flex items-center gap-6 mb-4">
          ...
          <div>
          <h2 className="text-2xl font-bold mb-2">Introduction to CSS</h2>
            <p className="text-base text-gray-600 dark:text-gray-800">
