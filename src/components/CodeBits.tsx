...
import { useToast } from '../leaderboard_src/hooks/use-toast';
import { motion, useAnimation } from 'framer-motion';
import { CodeBit } from '@/types/codeBits';

// Import components
import { SpaceBackground } from './codebits/AnimationEffects';

import Header from './codebits/Header';
import SearchBar from './codebits/SearchBar';
import CategoryTabs from './codebits/CategoryTabs';
import CategoryFilters from './codebits/CategoryFilters';
import CodeBitGrid from './codebits/CodeBitGrid';
import Pagination from './codebits/Pagination';
import FloatingActions from './codebits/FloatingActions';
import CodeBitModal from './codebits/CodeBitModal';
import AchievementNotification from './codebits/AchievementNotification';
