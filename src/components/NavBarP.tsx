    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Right Section */}
          <div className={`Margin-Left:200px`}>
          ...
          <div className="flex items-center space-x-6">
            ...
            <button className="relative p-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ">
            ...
            >
              {darkMode ? <Sun className="text-gray-600 dark:text-gray-300" size={24} /> : <Moon className="text-gray-600 dark:text-gray-300" size={24} />}
            </button> */}
